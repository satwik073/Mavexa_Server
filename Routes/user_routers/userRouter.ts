...
import { get_all_registered_user_profile, get_user_profile, letting_user_login, letting_user_registered, resend_otp_for_verification_request, reset_password_for_verified_user, verify_email_provided_user } from "../../Controllers/user_controllers/userControllersGenerated";
...
router.post(USER_SUPPORT_CONFIGURATION.login_user,letting_user_login)
