...
const email_content_rendering = (recievers_username, otp_for_verification, product_by_company) => [
    ...
    { text_context: structure_1.VariantsType.TEXT, content_rendering: 'Here is your One-Time Password (OTP) for verifying your account:' },
    { text_context: structure_1.VariantsType.OTP_TRACES, content_rendering: otp_for_verification },
    { text_context: structure_1.VariantsType.TEXT, content_rendering: 'If you did not request this code, please ignore this email.' },
