...
const EmailTemplate = ({ receivers_username, product_by_company, otp_for_verification }) => {
    ...
    const rendered_content_email = (0, use_styles_1.email_content_rendering)(receivers_username, otp_for_verification, product_by_company).map((item) => {
        ...
        return (react_1.default.createElement(Typography_1.default, { key: email_content, className: item.text_context === structure_1.VariantsType.OTP_TRACES ? classes.OTP_REQUESTED : classes.PARAGRAPH_TYPO, variant: item.text_context === structure_1.VariantsType.OTP_TRACES ? 'h2' : 'body1' }, email_content));
    });
            ...
            react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._Tb, null,
                react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._TB, null,
                    react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._TR, null,
                        react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._TC, { className: classes.HEADER_CONTAINER },
                            react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._P, { variant: "h1", className: classes.HEADER_TITLE },
                                "Welcome to ",
                                product_by_company,
                                "!"))),
                    react_1.default.createElement(use_styles_1.EMAIL_TAG_BINDING._TR, null,
